...
const socialLinks = [
    ...
    {
      href: 'https://wa.me/+2348036580132', // Replace 'yourwhatsappnumber' with your actual WhatsApp number
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2C6.486 2 2 6.486 2 12c0 2.207.79 4.25 2.086 5.873l-.486 2.11a1 1 0 00.682 1.17c.14.03.285.045.434.045.535 0 1.06-.16 1.5-.463l2.456-1.25A10.044 10.044 0 0012 22c5.514 0 10-4.486 10-10S17.514 2 12 2zm5.312 14.288l-1.488.794a1 1 0 01-1.395-.447l-.01-.024a.998.998 0 01.447-1.395l1.488-.794a.998.998 0 011.395.447l.01.024a.998.998 0 01-.447 1.395zm-5.121-2.39l-1.44.764a.998.998 0 01-1.395-.447l-.01-.024a.998.998 0 01.447-1.395l1.44-.764a.998.998 0 011.395.447l.01.024a.998.998 0 01-.447 1.395z" fill="currentColor" />
  </svg>,
      alt: 'WhatsApp'
    }
  ];
    ...
    <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col ">
            ...
            <h2 className="headline-2 lg:max-w-[12ch] reveal-up">
                Collaborate with Me – Let’s Get Started!
            </h2>

            <p className="text-zinc-400 mt-3 mb-8 maz-w-[50ch] lg:max-w-[30ch] reveal-up">
            Ready to bring your ideas to life? Reach out and let’s explore how my expertise can deliver the results you’re looking for!
            </p>
        ...
        <form 
            action="https://getform.io/f/alljdpla"
            method="POST"
            ...
            <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                ...
                <div className="mb-4">
                    ...
                    <input 
                        ...
                        autoComplete="email"
                        required
                        placeholder="otingbemiga@example.com"
                        className="text-field reveal-up"
                    />
                </div>
            </div>
